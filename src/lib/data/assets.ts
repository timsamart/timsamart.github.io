...
const Assets = {
	...
	GenerativeAI: a('generative-ai.png'),
    ArtificialIntelligence: a('artificial-intelligence.png'),
    MachineLearning: a('machine-learning.png'),
    ComputerVision: a('computer-vision.png'),
    Programming: a('programming.png'),
    SoftwareDevelopment: a('software-development.png'),
    ProjectManagement: a('project-management.png'),
    AgileProjectManagement: a('agile-project-management.png'),
    Innovation: a('innovation.png'),
    TechnicalExpertise: a('technical-expertise.png'),
    VisionaryMindset: a('visionary-mindset.png'),
    EmpatheticLeadership: a('empathetic-leadership.png'),
    RegulatoryCompliance: a('regulatory-compliance.png'),
    InterdisciplinaryTeamManagement: a('interdisciplinary-team-management.png'),
    DigitalElectronics: a('digital-electronics.png'),
